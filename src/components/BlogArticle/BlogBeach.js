          ...
          <div className="article__container-text">
            {window.innerWidth > 768 ? (
              <p className="article__text">
                ...
                водных объектах путем сравнительного анализа действенности мер
                по обеспечению безопасности на автомобильных дорогах (10,8 тысяч
                постов фото-видеофиксации, стационарные посты, а также мобильные
                экипажи) и безопасности акваторий (12 тысяч постов и
                спасательных станций). Соотношение количества погибших в 2019
                году от утопления (около 4 тысяч человек) к погибшим в ДТП (13,3
                ...
                количества зафиксированных нарушений правил пользования водными
                объектами (34 тыс.) к нарушениям ПДД (106 млн.) составляет 1 к
                3000, что наглядно демонстрирует незначительность
                профилактических мер по снижение смертности на водных объектах.
                Спасательные посты и станции не оборудованы специальными
                техническими комплексами мониторинга, позволяющими фиксировать
                нарушения правил эксплуатации водных объектов (аналогично
                комплексам фото-видеофиксации). Мониторинг безопасности на
                водных объектах полностью возложен на спасателей (это
        ...
        <div className="article__under-text-container article__under-text-container_mini-bottom">
          {window.innerWidth > 768 ? (
            ...
            <p className="article__text">
              ...
              незначительность профилактических мер по снижение смертности на
              водных объектах. Спасательные посты и станции не оборудованы
              специальными техническими комплексами мониторинга, позволяющими
              фиксировать нарушения правил эксплуатации водных объектов
              (аналогично комплексам фото-видеофиксации). Мониторинг
        ...
        <div className="article__under-text-container">
          {window.innerWidth > 770 ? (
            ...
            <p className="article__text">
              ...
              предыдущих и последующих кадров. Отделение «аномальных объектов»
              от основного пула объектов в воде осуществляется за счет
              использования совокупности алгоритмов, характерных для поведения
              человека в воде, таких как: скорость, инерция и вектор движения
              пловца, а также комфортное и допустимое время нахождения пловца
              под водой.
            </p>
          )}
