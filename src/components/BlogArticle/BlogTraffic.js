      ...
      <section className="article" id="blog-traffic">
        <div className="article__container">
          ...
          <div className="article__container-text">
            ...
            <p className="article__text">
              ...
              предложением по разгрузке Московского дорожного трафика. Компания
              занимается созданием систем компьютерного зрения. Особенность их
              парадигмы — это работа с данными уже существующих видеокамер. Цель
              создания интеллектуальной платформы «Дорожная аналитика»
              заключается в том, чтобы помочь транспортным службам быстрее
        ...
        <div className="article__under-text-container">
          <p className="article__text">
            ...
            порядка 90 часов в транспортных заторах. Для Москвы дорожные пробки
            — это не абстрактные проблемы водителей и пассажиров. Это повышенный
            расход топлива и энергии общественного транспорта, препятствия для
          ...
          <p className="article__text article__text-second">
            ...
            на перекрестке. Эти решения уже хорошо зарекомендовали себя, однако,
            чтобы оборудовать всю транспортную сеть Москвы подобной техникой
            требуются значительные финансовые и временные ресурсы. Стоит
            отметить, что на рынке существуют и другие технические решения для
            мониторинга дорожной обстановке. Например, видеоаналитика и
          ...
          <p className="article__text article__text-last">
            ...
            открывает огромный потенциал для их переиспользования.
          </p>
        </div>
        ...
        <div className="article__container">
          ...
          <div className="article__container-text">
            ...
            <p className="article__text article__text-second">
              ...
              существенно снижает общую стоимость использования предлагаемой ими
              технологии.
            </p>
          </div>
        </div>
        ...
        <div className="article__under-text-container">
          ...
          <p className="article__text">
            Показательно рассмотреть мировой опыт того, как собирают данные и
            реагируют на дорожные инциденты в разных странах мира:
          </p>
        </div>
          ...
          <div className="article__container-text">
            <ul className="article__list">
              ...
              <li className="article__list-item  article__list-item_point">
                ...
                необходимость устанавливать дополнительные камеры отпадает сама
        ...
        <div className="article__under-text-container">
          <p className="article__text">
            ...
            пробке. Надеемся, у них все получится!
          </p>
        </div>
      </section>
